...
import ru.clevertec.customlist.CustomLinkedList;
...
/*
* Этот тест чистая копипаста с CustomArrayListTest, заменена только реалтзация List<I> testList в @BeforeTest
*
* */
